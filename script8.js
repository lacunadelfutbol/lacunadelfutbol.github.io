...
// ----- CONFIGURACIÓN -----
const TOTAL_ASISTENCIAS_POSIBLES = 52;

// ----- Datos de ejemplo -----
const jugadores = [
    { nombre: "YEIK SOLIS", asistencias: [5,7,6,8,7,9,9,0,0,0,0,0] },
    { nombre: "ALEXANDER SOLIS", asistencias: [5,6,6,7,7,9,9,0,0,0,0,0] },
    { nombre: "MATEO RODRIGUEZ", asistencias: [2,5,4,6,4,3,5,0,0,0,0,0] },
    ...
    { nombre: "ANGEL GOMEZ", asistencias: [0,0,0,0,0,4,3,0,0,0,0,0] },
    { nombre: "LEO", asistencias: [1,0,1,0,3,1,0,0,0,0,0,0] },
    { nombre: "FERNANDO ANGELES", asistencias: [3,7,3,4,1,6,1,0,0,0,0,0] },
    { nombre: "GABRIEL HERNANDEZ", asistencias: [3,2,2,3,7,6,8,0,0,0,0,0] },
    { nombre: "BARUSH AMADOR", asistencias: [1,2,4,4,5,4,2,0,0,0,0,0] },
    { nombre: "ALAIN AMADOR", asistencias: [3,6,4,6,6,7,3,0,0,0,0,0] },
    { nombre: "ALEXIS HERNANDEZ", asistencias: [4,5,3,5,5,4,6,0,0,0,0,0] },
    { nombre: "FRANKI AMADOR", asistencias: [2,7,4,5,6,5,3,0,0,0,0,0] },
    ...
    { nombre: "MATI HERNANDEZ", asistencias: [1,2,2,1,4,5,7,0,0,0,0,0] },
    { nombre: "SANTI HERNANDEZ", asistencias: [1,2,2,1,4,5,7,0,0,0,0,0] },
    { nombre: "GERARDO GONZALEZ", asistencias: [0,0,2,3,2,0,0,0,0,0,0,0] },
    { nombre: "IAN CASTILLO", asistencias: [1,5,2,5,5,6,8,0,0,0,0,0] },
    ...
    { nombre: "SANTIAGO MENESES", asistencias: [0,0,0,0,0,0,3,0,0,0,0,0] },
