...
const TOTAL_ASISTENCIAS_POSIBLES = 18;

// ----- Datos de ejemplo -----
const jugadores = [
    { nombre: "YEIK SOLIS", asistencias: [5,7,6,0,0,0,0,0,0,0,0,0] },
    { nombre: "ALEXANDER SOLIS", asistencias: [5,6,6,0,0,0,0,0,0,0,0,0] },
    { nombre: "MATEO RODRIGUEZ", asistencias: [2,5,4,0,0,0,0,0,0,0,0,0] },
    { nombre: "ALAN MELO", asistencias: [4,7,3,0,0,0,0,0,0,0,0,0] },
    ...
    { nombre: "FRANKI AMADOR", asistencias: [2,7,4,0,0,0,0,0,0,0,0,0] },
