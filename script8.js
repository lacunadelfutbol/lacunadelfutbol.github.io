...
// ----- CONFIGURACIÓN -----
const TOTAL_ASISTENCIAS_POSIBLES = 33;

// ----- Datos de ejemplo -----
const jugadores = [
    { nombre: "YEIK SOLIS", asistencias: [5,7,6,8,6,0,0,0,0,0,0,0] },
    { nombre: "ALEXANDER SOLIS", asistencias: [5,6,6,7,6,0,0,0,0,0,0,0] },
    { nombre: "MATEO RODRIGUEZ", asistencias: [2,5,4,6,3,0,0,0,0,0,0,0] },
    { nombre: "ALAN MELO", asistencias: [4,7,3,6,4,0,0,0,0,0,0,0] },
    { nombre: "MICHEL MORALES", asistencias: [3,6,2,5,3,0,0,0,0,0,0,0] },
    { nombre: "ARTURO TREJO", asistencias: [4,2,2,2,2,0,0,0,0,0,0,0] },
    { nombre: "KARIM VALENCIA", asistencias: [2,6,4,5,5,0,0,0,0,0,0,0] },
    { nombre: "JOSMAR VALENCIA", asistencias: [2,6,4,5,5,0,0,0,0,0,0,0] },
    { nombre: "AXEL PELCASTRE", asistencias: [3,4,3,6,2,0,0,0,0,0,0,0] },
    { nombre: "SANTIAGO PECASTRE", asistencias: [3,4,3,6,3,0,0,0,0,0,0,0] },
    ...
    { nombre: "GABRIEL HERNANDEZ", asistencias: [3,2,2,3,6,0,0,0,0,0,0,0] },
    { nombre: "BARUSH AMADOR", asistencias: [1,2,4,4,4,0,0,0,0,0,0,0] },
    { nombre: "ALAIN AMADOR", asistencias: [3,6,4,6,5,0,0,0,0,0,0,0] },
    { nombre: "ALEXIS HERNANDEZ", asistencias: [4,5,3,5,4,0,0,0,0,0,0,0] },
    { nombre: "FRANKI AMADOR", asistencias: [2,7,4,5,5,0,0,0,0,0,0,0] },
    { nombre: "CRISTOPHER ZARCO", asistencias: [3,4,3,3,3,0,0,0,0,0,0,0] },
    { nombre: "ANGEL PEREZ", asistencias: [3,4,3,3,3,0,0,0,0,0,0,0] },
    { nombre: "MATEO", asistencias: [0,0,0,0,3,0,0,0,0,0,0,0] },
    { nombre: "MATI HERNANDEZ", asistencias: [1,2,2,1,4,0,0,0,0,0,0,0] },
    { nombre: "SANTI HERNANDEZ", asistencias: [1,2,2,1,4,0,0,0,0,0,0,0] },
    { nombre: "GERARDO GONZALEZ", asistencias: [0,0,2,3,1,0,0,0,0,0,0,0] },
    { nombre: "IAN CASTILLO", asistencias: [1,5,2,5,5,0,0,0,0,0,0,0] },
    { nombre: "RICARDO CASTILLO", asistencias: [1,5,2,5,5,0,0,0,0,0,0,0] },
